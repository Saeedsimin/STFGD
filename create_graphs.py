...
### load datasets
    ...
    # real graphs
        ...
        graphs = [] # graph comes with enourmous number of nodes 
        for G in graphs_raw:
        ...
        graphs = Graph_load_batch(min_num_nodes=2, max_num_nodes=500, name='YELP',node_attributes=True,graph_labels=True)
        args.max_prev_node = 10        
    elif args.graph_type == 'amazon':
        graphs = Graph_load_batch(min_num_nodes=2, max_num_nodes=500, name='Amazon',node_attributes=True,graph_labels=True)
        args.max_prev_node = 20        
