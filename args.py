...
#         self.graph_type = 'yelp'
        self.graph_type = 'amazon'
        ...
        self.dir_input = "./"
        self.model_save_path = self.dir_input+'modified_model_save/' # only for nll evaluation
        self.graph_save_path = self.dir_input+'modified_graphs/'
        self.figure_save_path = self.dir_input+'modified_figures/'
        self.timing_save_path = self.dir_input+'modified_timing/'
        self.figure_prediction_save_path = self.dir_input+'modified_figures_prediction/'
        self.nll_save_path = self.dir_input+'modified_nll/'
        ...
        self.fname_test_with_id = self.note + '_' + self.graph_type + '_' + str(self.num_layers) + '_' + str(self.hidden_size_rnn) + '_test_with_id_'        
